...
ESM Scan uses the ESM-2 transformer model to predict the functional impact of protein mutations. It supports both full-sequence scans and specific mutation scoring.
