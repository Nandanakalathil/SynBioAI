...
import argparse
import torch
from src.encoding_utils import generate_onehot, generate_all_combos, generate_esm2
...
if __name__ == "__main__":
    ...
    parser.add_argument("--encoding", type=str, default="onehot", choices=["onehot", "ESM2"])
    ...
    elif args.encoding == "ESM2":
        print(f"Generating ESM2 embeddings for {len(all_combos)} sequences (this might take some time)...")
        X = generate_esm2(all_combos)
        torch.save(X, path + 'ESM2_x.pt')
