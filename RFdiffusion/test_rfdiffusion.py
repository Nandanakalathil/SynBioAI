...
# Step 2: Upload payload to S3 (async requires input from S3)
payload = {
    "contigs":       args.contigs,
    "num_designs":   args.num_designs,
    "output_prefix": "/tmp/rfdiffusion/design",
}
if s3_key:
...
for s3_output in result.get('s3_outputs', []):
    ...
    local_output  = os.path.join(args.output_dir, os.path.basename(s3_key_out))
