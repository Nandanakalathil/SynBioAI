# ALDE: Active Learning for Design
This directory contains the implementation and deployment scripts for the **ALDE (Active Learning for DEsign)** SageMaker asynchronous endpoint. ALDE recommends optimal protein sequences based on provided fitness data.
